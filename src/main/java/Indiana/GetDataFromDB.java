...
public class GetDataFromDB 
{
	...
	//public static void main(String[] args)  throws Exception
	{
        ...
        ResultSet rs = null;
            ...
            String SQL = "Select Charge from "+IN_RunnerClass.chargeCodesTable+"";
	...
	//public static void main(String[] args)  throws Exception
	{
        ...
        ResultSet rs = null;
            //Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            con = DriverManager.getConnection(connectionUrl);
            String SQL = "Select Charge, ChargeCode,Description,StartDate,Amount from "+IN_RunnerClass.chargeCodesTable+" where MoveInCharge = 1";
	...
	//public static void main(String[] args)  throws Exception
	{
        ...
        ResultSet rs = null;
            //Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            con = DriverManager.getConnection(connectionUrl);
            String SQL = "Select Charge, ChargeCode,Description,autoCharge_StartDate,Amount,endDate from "+IN_RunnerClass.chargeCodesTable+" where AutoCharge = 1";
	 ...
	 public static boolean assignChargeCodes(String moveInChargesIDs, String autoChargesIDs)
		{
		  String connectionUrl = "jdbc:sqlserver://azrsrv001.database.windows.net;databaseName=HomeRiverDB;user=service_sql02;password=xzqcoK7T;encrypt=true;trustServerCertificate=true;";
		    String sql = "update "+IN_RunnerClass.chargeCodesTable+" Set MoveInCharge ='1' where ID in  ("+moveInChargesIDs+")\n"
		    		+ "update "+IN_RunnerClass.chargeCodesTable+" Set AutoCharge ='1' where ID in  ("+autoChargesIDs+")";
