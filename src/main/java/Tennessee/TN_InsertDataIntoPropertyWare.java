			...
			*/
			...
			//pet information
				...
				try
				{
					...
					RunnerClass.driver.findElement(Locators.initialPetRentAmount).sendKeys(TN_PropertyWare.petRent);
				...
				try
				{
					...
					RunnerClass.driver.findElement(Locators.petRentAmount).sendKeys(TN_PropertyWare.petRent);
			...
			try
			{
				...
				//RunnerClass.driver.findElement(Locators.initialMonthlyRent).clear();
					...
					RunnerClass.driver.findElement(Locators.currentMonthlyRent).sendKeys(TN_PropertyWare.monthlyRent);
