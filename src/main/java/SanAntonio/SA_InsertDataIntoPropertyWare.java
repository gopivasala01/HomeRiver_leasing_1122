...
public class SA_InsertDataIntoPropertyWare 
{
	...
	public static boolean insertData() throws Exception 
	{
		...
		String query = "Update "+SA_RunnerClass.chargeCodesTable+" Set Amount=NULL,StartDate=NULL,EndDate=NULL,MoveINCharge=NULL,autoCharge=NULL,AutoCharge_StartDate=NULL";
		InsertDataIntoDatabase.updateTable(query);

		//Check if Prorated Rent Date is in Move in Date month
		SA_PropertyWare.proratedRentDateIsInMoveInMonthFlag =  SA_PropertyWare.checkProratedRentDateIsInMoveInMonth(); 
		System.out.println("Prorated Rent is in move in month = "+SA_PropertyWare.proratedRentDateIsInMoveInMonthFlag);
		if(SA_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true)
		{
			if(SA_PropertyWare.proratedRentDate.equalsIgnoreCase("n/a")||SA_PropertyWare.proratedRentDate.equalsIgnoreCase("na")||SA_PropertyWare.proratedRentDate.equalsIgnoreCase("N/A")||SA_PropertyWare.proratedRentDate.equalsIgnoreCase("NA"))
			{
				prepaymentChargeOrMonthlyRent = "2";
				SA_PropertyWare.proratedPetRent = SA_PropertyWare.petRent;
			}
			else
		...
		//if(SA_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true&&SA_PropertyWare.portfolioType=="MCH")
			//prepaymentChargeOrMonthlyRent = "9";
			//else 
			//prepaymentChargeOrMonthlyRent = "9";
		...
		if(SA_PropertyWare.portfolioType=="Others")
		{
			/*
			if(SA_PropertyWare.concessionAddendumFlag==true)
			{
				SA_InsertDataIntoPropertyWare.OtherPortfolios_chargesWhenConsessionAddendumIsAvailable();
			}
			else
			{
				SA_InsertDataIntoPropertyWare.OtherPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
			}
			*/
			SA_InsertDataIntoPropertyWare.OtherPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
		}
		//MCH type
		if(SA_PropertyWare.portfolioType=="MCH")
		{
			/*
			if(SA_PropertyWare.concessionAddendumFlag==true)
			{
				SA_InsertDataIntoPropertyWare.MCHPortfolios_chargesWhenConsessionAddendumIsAvailable();
			}
			else
			{
				SA_InsertDataIntoPropertyWare.MCHPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
			}
			*/
			SA_InsertDataIntoPropertyWare.MCHPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
		}
		//Update other fields for charges
		SA_InsertDataIntoPropertyWare.updateOtherFieldsInConfigurationTable();
		...
		// Get Move in charges
		SA_GetDataFromDB.getMoveInCharges();
		for(int i=0;i<moveInCharges.length;i++)
		{
			...
			SA_RunnerClass.FL_wait = new WebDriverWait(RunnerClass.driver, Duration.ofSeconds(5));
		...
		// Get Auto charges
	     SA_GetDataFromDB.getAutoCharges();
	     System.out.println("------Auto Charges-------");
			...
			for(int i=0;i<autoCharges.length;i++)
			{
				...
				//End Date
				if(autoCharges[i][5]!=null&&autoCharges[i][5]!="") //SA_PropertyWare.portfolioType=="Others"&&
				{
			...
			try
			{
				if(SA_PropertyWare.RCDetails.equalsIgnoreCase("Error"))
				{
				...
				Thread.sleep(1000);
				RunnerClass.driver.findElement(Locators.rcField).sendKeys(SA_PropertyWare.RCDetails);
				}
			}
			catch(Exception e)
			{
				try
				{
					...
					Thread.sleep(1000);
					RunnerClass.driver.findElement(Locators.APMField).sendKeys(SA_PropertyWare.RCDetails);
				}
				catch(Exception e2)
				{
				InsertDataIntoDatabase.notAutomatedFields(RunnerClass.leaseName, "RC Details"+'\n');
			...
			try
			{
				if(SA_PropertyWare.earlyTermination.equalsIgnoreCase("Error"))
				{
			...
			if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
			{
				...
				//if(SA_PropertyWare.HVACFilterFlag==false)
			...
			else
			{
				...
				if(SA_PropertyWare.airFilterFee!="Error")
				{
				Thread.sleep(2000);
				try
				{
			...
			try
			{
				if(SA_PropertyWare.occupants.equalsIgnoreCase("Error"))
				{
				...
				Thread.sleep(1000);
				RunnerClass.driver.findElement(Locators.leaseOccupants).sendKeys(SA_PropertyWare.occupants);
				}
			}
			catch(Exception e)
			{
			...
			if(SA_PropertyWare.petFlag==true)
			{
			//pet information
				Thread.sleep(2000);
				
				//Pet Type
				String petType = String.join(",", SA_PropertyWare.petType);
				try
				{
				...
				Thread.sleep(2000);
				//Pet Breed
				String petBreed = String.join(",", SA_PropertyWare.petBreed);
				try
				{
				...
				//Pet Weight
				String petWeight = String.join(",", SA_PropertyWare.petWeight);
				try
				{
				...
				try
				{
					if(SA_PropertyWare.petRent.equalsIgnoreCase("Error"))
					{
					...
					//SA_PropertyWare.clearTextField();
					...
					RunnerClass.driver.findElement(Locators.petAmount).sendKeys(SA_PropertyWare.petRent);
						}
						catch(Exception e)
						{
							...
							Thread.sleep(1000);
							//RunnerClass.actions.click(RunnerClass.driver.findElement(Locators.petAmount)).sendKeys(Keys.SHIFT).sendKeys(Keys.HOME).sendKeys(Keys.BACK_SPACE).build().perform();
							RunnerClass.driver.findElement(Locators.petAmount2).sendKeys(SA_PropertyWare.petRent);
						}
					}
				}
				catch(Exception e)
				...
				try
				{
					if(SA_PropertyWare.petOneTimeNonRefundableFee.equalsIgnoreCase("Error"))
					{
					...
					RunnerClass.driver.findElement(Locators.tenantOneTimePetFee).sendKeys(SA_PropertyWare.petOneTimeNonRefundableFee);
						}
						catch(Exception e)
						{
							...
							//SA_PropertyWare.clearTextField();
							//RunnerClass.actions.click(RunnerClass.driver.findElement(Locators.tenantOneTimePetFee)).sendKeys(Keys.SHIFT).sendKeys(Keys.HOME).sendKeys(Keys.BACK_SPACE).build().perform();
							RunnerClass.driver.findElement(Locators.tenantOneTimePetFee2).sendKeys(SA_PropertyWare.petOneTimeNonRefundableFee);
						}
					}
				}
				catch(Exception e)
				...
				try
				{
					...
					RunnerClass.driver.findElement(Locators.initialPetRentAmount).sendKeys(SA_PropertyWare.petRent);
				...
				try
				{
					...
					RunnerClass.driver.findElement(Locators.petRentAmount).sendKeys(SA_PropertyWare.petRent);
				...
				if(SA_PropertyWare.serviceAnimalFlag==true)
				{
					Thread.sleep(2000);
					
					//Pet Type
					String ServiceAnimal_petType = String.join(",", SA_PropertyWare.serviceAnimalPetType);
					try
					{
					...
					Thread.sleep(2000);
					//Pet Breed
					String serviceAnimal_petBreed = String.join(",", SA_PropertyWare.serviceAnimalPetBreed);
					try
					{
					...
					Thread.sleep(2000);
					//Pet Weight
					String serviceAnimal_petWeight = String.join(",", SA_PropertyWare.serviceAnimalPetWeight);
					try
					{
				...
				try
				{
					//if(!SA_PropertyWare.petSecurityDeposit.equalsIgnoreCase("Error")||!SA_PropertyWare.petSecurityDeposit.trim().equalsIgnoreCase(" ")||!SA_PropertyWare.petSecurityDeposit.trim().equalsIgnoreCase(""))
					if(RunnerClass.onlyDigits(SA_PropertyWare.petSecurityDeposit.trim())==true)
					{
					...
					Thread.sleep(1000);
					//RunnerClass.actions.click(RunnerClass.driver.findElement(Locators.petAmount)).sendKeys(Keys.SHIFT).sendKeys(Keys.HOME).sendKeys(Keys.BACK_SPACE).build().perform();
					RunnerClass.driver.findElement(Locators.petDepositAmount).sendKeys(SA_PropertyWare.petSecurityDeposit);
					}
				}
				catch(Exception e)
				{
			...
			try
			{
				if(SA_PropertyWare.monthlyRent.equalsIgnoreCase("Error"))
				{
				...
				RunnerClass.driver.findElement(Locators.initialMonthlyRent).sendKeys(SA_PropertyWare.monthlyRent);
			...
			try
			{
				...
				//RunnerClass.driver.findElement(Locators.initialMonthlyRent).clear();
					...
					RunnerClass.driver.findElement(Locators.currentMonthlyRent).sendKeys(SA_PropertyWare.monthlyRent);
			...
			//Late Fee Rule
			//SA_InsertDataIntoPropertyWare.lateFeeRuleMethod(SA_PropertyWare.lateFeeType);
	...
	public static void updateOtherFieldsInConfigurationTable() throws Exception
	{
		...
		SA_GetDataFromDB.getChargesFromConfigurationTable();
		String DayInCommensementDate = RunnerClass.convertDate(SA_PropertyWare.commensementDate).split("/")[1].trim();
		...
		{
			firstFullMonth = RunnerClass.convertDate(SA_PropertyWare.commensementDate).trim();
			secondFullMonth = RunnerClass.firstDayOfFullMonth(RunnerClass.convertDate(SA_PropertyWare.commensementDate));
			String updateStartDateAndEndDate = "Update "+SA_RunnerClass.chargeCodesTable+" Set StartDate='"+RunnerClass.convertDate(SA_PropertyWare.commensementDate)+"' where moveInCharge =1 \n"
					+ "Update "+SA_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+secondFullMonth+"' where AutoCharge =1 \n"
							+ "Update "+SA_RunnerClass.chargeCodesTable+" Set endDate='"+RunnerClass.DateModified(firstFullMonth)+"' where Charge ='Pro Rate Rent' ";
			InsertDataIntoDatabase.updateTable(updateStartDateAndEndDate);
		}
		else 
		{
		firstFullMonth = RunnerClass.firstDayOfFullMonth(RunnerClass.convertDate(SA_PropertyWare.commensementDate));
		secondFullMonth = RunnerClass.NextMonthOffirstDayOfFullMonth(RunnerClass.convertDate(SA_PropertyWare.commensementDate));
		String updateStartDateAndEndDate = "Update "+SA_RunnerClass.chargeCodesTable+" Set StartDate='"+RunnerClass.convertDate(SA_PropertyWare.commensementDate)+"' where moveInCharge =1 \n"
				+ "Update "+SA_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+firstFullMonth+"' where AutoCharge =1 \n"
						+ "Update "+SA_RunnerClass.chargeCodesTable+" Set endDate='"+RunnerClass.DateModified(firstFullMonth)+"' where Charge ='Pro Rate Rent' ";
		InsertDataIntoDatabase.updateTable(updateStartDateAndEndDate);
		}
		...
		if(RunnerClass.onlyDigits(SA_PropertyWare.increasedRent_amount.trim().replace(",", "").replace(".", ""))==true)
		{
		String updateMonthlyRentStartDateToNextMonthOfFirstFullMonth = "Update "+SA_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+RunnerClass.firstDayOfFullMonth(RunnerClass.convertDate(SA_PropertyWare.commensementDate))+"',EndDate ='"+RunnerClass.convertDate(SA_PropertyWare.increasedRent_previousRentEndDate.trim())+"'  where ID=2";
		...
		try
		{
		if(SA_PropertyWare.portfolioType=="Others") //Double.parseDouble(SA_PropertyWare.proratedRent.trim())<=200.00|| //||SA_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true
		{
			String updateMonthlyRentStartDateWhenProrateRentIsUnder200Dollers = "Update "+SA_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+secondFullMonth+"' where ID=2";
		...
		try
		{
		if(SA_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true&&(SA_PropertyWare.proratedPetRent!=""||SA_PropertyWare.proratedPetRent!=null||!SA_PropertyWare.proratedPetRent.equalsIgnoreCase("na")||!SA_PropertyWare.proratedPetRent.equalsIgnoreCase("n/a"))&&(DayInCommensementDate.equalsIgnoreCase("01")||DayInCommensementDate.equalsIgnoreCase("1"))) //Double.parseDouble(SA_PropertyWare.proratedRent.trim())<=200.00||
		{
			String updateMonthlyRentStartDateWhenProrateRentIsUnder200Dollers = "Update "+SA_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+secondFullMonth+"' where ID=8";
			InsertDataIntoDatabase.updateTable(updateMonthlyRentStartDateWhenProrateRentIsUnder200Dollers);
		}
		}
		catch(Exception e) {}
		...
		for(int i=0;i<charges.length;i++)
		{
			...
			{
			case "Pro Rate Rent":
				query = "Update "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.proratedRent+"' where charge ='Pro Rate Rent'";
				//InsertDataIntoDatabase.updateTable(query1);
				continue;
				
			case "Monthly Rent":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.monthlyRent+"' where charge ='Monthly Rent'";
				//InsertDataIntoDatabase.updateTable(query2);
				continue;
			case "Tenant Admin Revenue":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.adminFee+"' where charge ='Tenant Admin Revenue'";
				//InsertDataIntoDatabase.updateTable(query3);
				continue;
			case "Pro Rated Pet Rent":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.proratedPetRent+"' where charge ='Pro Rated Pet Rent'";
				//InsertDataIntoDatabase.updateTable(query4);
				continue;
			case "Pet Security Deposit":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.petSecurityDeposit+"' where charge ='Pet Security Deposit'";
				//InsertDataIntoDatabase.updateTable(query5);
				continue;
			case "Pet One Time Non Refundable":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.petOneTimeNonRefundableFee+"' where charge ='Pet One Time Non Refundable'";
				//InsertDataIntoDatabase.updateTable(query6);
				continue;
			case "HVAC Filter Fee":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.airFilterFee+"' where charge ='HVAC Filter Fee'";
				//InsertDataIntoDatabase.updateTable(query7);
				continue;
			case "Pet Rent":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.petRent+"' where charge ='Pet Rent'";
				//InsertDataIntoDatabase.updateTable(query8);
				continue;
			case "Pre Payment Charge":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.prepaymentCharge+"' where charge ='Pre Payment Charge'";
				//InsertDataIntoDatabase.updateTable(query9);
				continue;
			case "Increased Rent":
				try {
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.increasedRent_amount+"',autoCharge_StartDate ='"+RunnerClass.convertDate(SA_PropertyWare.increasedRent_newStartDate)+"' where charge ='Increased Rent'";
			...
			case "Resident Benefits Package":
				if(SA_PropertyWare.proratedRentDate.equalsIgnoreCase("n/a")||SA_PropertyWare.proratedRentDate.equalsIgnoreCase("na")||SA_PropertyWare.proratedRentDate.equalsIgnoreCase("N/A")||SA_PropertyWare.proratedRentDate.equalsIgnoreCase("NA"))
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.residentBenefitsPackage+"',startDate ='"+RunnerClass.convertDate(SA_PropertyWare.commensementDate).trim()+"',autoCharge_startDate='"+secondFullMonth+"'  where charge ='Resident Benefits Package'";
				else
					query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.residentBenefitsPackage+"',startDate ='"+RunnerClass.convertDate(SA_PropertyWare.commensementDate).trim()+"',autoCharge_startDate='"+firstFullMonth+"'  where charge ='Resident Benefits Package'";
				//InsertDataIntoDatabase.updateTable(query9);
				continue;
			case "Monthly Rent - New MCH":
				query = query+"\nUpdate "+SA_RunnerClass.chargeCodesTable+" Set Amount ='"+SA_PropertyWare.monthlyRent+"',startDate ='"+RunnerClass.convertDate(SA_PropertyWare.commensementDate).trim()+"',autoCharge_startDate='"+firstFullMonth+"'  where ID = 12";
				//InsertDataIntoDatabase.updateTable(query9);
				continue;
			}
	...
	{
		if(SA_PropertyWare.portfolioType=="Others"&&SA_PropertyWare.petFlag==false)
		{
			if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
			{
			...
			SA_GetDataFromDB.assignChargeCodes(moveInCharges_1, autoCharges_1);
		}
		else
		{
			if(SA_PropertyWare.portfolioType=="Others"&&SA_PropertyWare.petFlag==true&&SA_PropertyWare.petSecurityDepositFlag==false)
			{
				if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
				{
			...
			else//(SA_PropertyWare.portfolioType=="Others"&&SA_PropertyWare.petFlag==true&&SA_PropertyWare.petSecurityDepositFlag==true)
			{
				if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
				{
	...
	{
		if(SA_PropertyWare.portfolioType=="MCH"&&SA_PropertyWare.petFlag==false)
		{
			if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
			{
				moveInCharges_1 = "1,"+prepaymentChargeOrMonthlyRent+",3,11";
				if(SA_PropertyWare.incrementRentFlag == true)
		...
		{
			if(SA_PropertyWare.portfolioType=="MCH"&&SA_PropertyWare.petFlag==true&&SA_PropertyWare.petSecurityDepositFlag==false)
			{
				if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
				{
		    ...
		    {
				if(SA_PropertyWare.portfolioType=="MCH"&&SA_PropertyWare.petFlag==true&&SA_PropertyWare.petSecurityDepositFlag==true)
				{
					if(SA_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
					{
	...
	public static void lateFeeRule() throws Exception
	{
		//Late Charges
		Thread.sleep(2000);
		if(SA_PropertyWare.additionalLateChargesLimit.contains("375"))
		{
			SA_PropertyWare.lateChargeDay = "2";
		}
		else SA_PropertyWare.lateChargeDay = String.valueOf(SA_PropertyWare.lateChargeDay.trim().charAt(0));

		try
		{
			if(SA_PropertyWare.lateChargeDay.equalsIgnoreCase("Error"))
			{
			...
			dueDayList.selectByVisibleText(SA_PropertyWare.lateChargeDay);
			}
		}
		catch(Exception e)
		{
		...
		try
		{
			if(SA_PropertyWare.lateChargeFee.equalsIgnoreCase("Error"))
			{
			...
			RunnerClass.driver.findElement(Locators.initialFee).sendKeys(SA_PropertyWare.lateChargeFee);
			}
		}
		catch(Exception e)
		{
		...
		try
		{
			if(SA_PropertyWare.lateChargeFee.contains("%"))
			{
		...
		try
		{
			if(SA_PropertyWare.lateFeeChargePerDay.equalsIgnoreCase("Error"))
			{
			...
			RunnerClass.driver.findElement(Locators.perDayFee).sendKeys(SA_PropertyWare.lateFeeChargePerDay);
			}
		}
		catch(Exception e)
		{
		...
		if(SA_RunnerClass.pdfFormatType.equalsIgnoreCase("Format1"))
	    {
			...
			if(SA_PropertyWare.additionalLateChargesLimit.contains("30"))
			{
				SA_PropertyWare.additionalLateChargesLimit = "12";
			...
			try
			{
				if(SA_PropertyWare.additionalLateChargesLimit.equalsIgnoreCase("Error"))
				{
				...
				else
				{
					...
					RunnerClass.driver.findElement(Locators.maximumDatField).sendKeys(SA_PropertyWare.additionalLateChargesLimit);
				}
			}
			catch(Exception e)
			{
		...
		public static boolean lateFeeRuleMethod(String type) throws Exception
		{
			...
			//if(SA_PropertyWare.lateFeeType =="GreaterOfFlatFeeOrPercentage")
			//{
				try
				{
...
//				Thread.sleep(2000);
				...
				try
				{
					...
					RunnerClass.actions.moveToElement(RunnerClass.driver.findElement(Locators.lateFeeDueDay)).build().perform();
					Select dueDayList = new Select(RunnerClass.driver.findElement(Locators.lateFeeDueDay)) ;
					dueDayList.selectByVisibleText(SA_PropertyWare.lateChargeDay.trim());
					}
				}
				catch(Exception e)
				{
