	    		...
	    		String increasedRent_ProviousRentEndDate = "Per the Landlord, Monthly Rent from "+FL_PropertyWare.commensementDate.trim()+" through ";
	    		 ...
	    		 if(endDateArray[2].trim().length()==4)//&&RunnerClass.onlyDigits(endDateArray[2]))
	    		 {
	    		  ...
	    		  System.out.println("Increased Rent - Amount = "+FL_PropertyWare.increasedRent_amount); 
	       		 ...
	       		 {
	       			 String adding0toMonth = "0"+FL_PropertyWare.commensementDate.trim().split(" ")[1];
	       			 String commeseDate = FL_PropertyWare.commensementDate.trim().replace(FL_PropertyWare.commensementDate.trim().split(" ")[1], adding0toMonth);
	       			 increasedRent_ProviousRentEndDate = "Per the Landlord, Monthly Rent from "+commeseDate+" through ";
	    	    		 ...
	    	    		 {
	    	    		  FL_PropertyWare.increasedRent_previousRentEndDate = endDateArray2[0]+" "+endDateArray2[1]+" "+endDateArray2[2];
	    	    		  System.out.println("Increased Rent - Previous rent end date = "+FL_PropertyWare.increasedRent_previousRentEndDate);
