...
public class OKC_InsertDataIntoPropertyWare 
{
	...
	public static boolean insertData() throws Exception 
	{
		...
		String query = "Update "+OKC_RunnerClass.chargeCodesTable+" Set Amount=NULL,StartDate=NULL,EndDate=NULL,MoveINCharge=NULL,autoCharge=NULL,AutoCharge_StartDate=NULL";
		InsertDataIntoDatabase.updateTable(query);

		//Check if Prorated Rent Date is in Move in Date month
		OKC_PropertyWare.proratedRentDateIsInMoveInMonthFlag =  OKC_PropertyWare.checkProratedRentDateIsInMoveInMonth(); 
		System.out.println("Prorated Rent is in move in month = "+OKC_PropertyWare.proratedRentDateIsInMoveInMonthFlag);
		if(OKC_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true)
		{
			if(OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("n/a")||OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("na")||OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("N/A")||OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("NA"))
			{
				prepaymentChargeOrMonthlyRent = "2";
				OKC_PropertyWare.proratedPetRent = OKC_PropertyWare.petRent;
			}
			else
		...
		//if(OKC_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true&&OKC_PropertyWare.portfolioType=="MCH")
			//prepaymentChargeOrMonthlyRent = "9";
			//else 
			//prepaymentChargeOrMonthlyRent = "9";
		...
		if(OKC_PropertyWare.portfolioType=="Others")
		{
			/*
			if(OKC_PropertyWare.concessionAddendumFlag==true)
			{
				OKC_InsertDataIntoPropertyWare.OtherPortfolios_chargesWhenConsessionAddendumIsAvailable();
			}
			else
			{
				OKC_InsertDataIntoPropertyWare.OtherPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
			}
			*/
			OKC_InsertDataIntoPropertyWare.OtherPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
		}
		//MCH type
		if(OKC_PropertyWare.portfolioType=="MCH")
		{
			/*
			if(OKC_PropertyWare.concessionAddendumFlag==true)
			{
				OKC_InsertDataIntoPropertyWare.MCHPortfolios_chargesWhenConsessionAddendumIsAvailable();
			}
			else
			{
				OKC_InsertDataIntoPropertyWare.MCHPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
			}
			*/
			OKC_InsertDataIntoPropertyWare.MCHPortfolios_chargesWhenConsessionAddendumIsNotAvailable();
		}
		//Update other fields for charges
		OKC_InsertDataIntoPropertyWare.updateOtherFieldsInConfigurationTable();
		...
		// Get Move in charges
		OKC_GetDataFromDB.getMoveInCharges();
		for(int i=0;i<moveInCharges.length;i++)
		{
			...
			OKC_RunnerClass.FL_wait = new WebDriverWait(RunnerClass.driver, Duration.ofSeconds(5));
		...
		// Get Auto charges
	     OKC_GetDataFromDB.getAutoCharges();
	     System.out.println("------Auto Charges-------");
			...
			for(int i=0;i<autoCharges.length;i++)
			{
				...
				//End Date
				if(autoCharges[i][5]!=null&&autoCharges[i][5]!="") //OKC_PropertyWare.portfolioType=="Others"&&
				{
			...
			try
			{
				if(OKC_PropertyWare.RCDetails.equalsIgnoreCase("Error"))
				{
				...
				Thread.sleep(1000);
				RunnerClass.driver.findElement(Locators.rcField).sendKeys(OKC_PropertyWare.RCDetails);
				}
			}
			catch(Exception e)
			{
				try
				{
					...
					Thread.sleep(1000);
					RunnerClass.driver.findElement(Locators.APMField).sendKeys(OKC_PropertyWare.RCDetails);
				}
				catch(Exception e2)
				{
					try
					{
						...
						Thread.sleep(1000);
						RunnerClass.driver.findElement(Locators.RC).sendKeys(OKC_PropertyWare.RCDetails);
					}
					catch(Exception e3)
					{
					InsertDataIntoDatabase.notAutomatedFields(RunnerClass.leaseName, "RC Details"+'\n');
			...
			try
			{
				if(OKC_PropertyWare.earlyTermination.equalsIgnoreCase("Error"))
				{
				...
				{
				if(OKC_PropertyWare.earlyTermination.contains("2"))
				{
			...
			else
			{
				...
				if(OKC_PropertyWare.airFilterFee!="Error")
				{
				Thread.sleep(2000);
				try
				{
			...
			try
			{
				if(OKC_PropertyWare.occupants.equalsIgnoreCase("Error"))
				{
				...
				Thread.sleep(1000);
				RunnerClass.driver.findElement(Locators.leaseOccupants).sendKeys(OKC_PropertyWare.occupants);
				}
			}
			catch(Exception e)
			{
			...
			if(OKC_PropertyWare.petFlag==true)
			{
			//pet information
				Thread.sleep(2000);
				
				//Pet Type
				String petType = String.join(",", OKC_PropertyWare.petType);
				try
				{
				...
				Thread.sleep(2000);
				//Pet Breed
				String petBreed = String.join(",", OKC_PropertyWare.petBreed);
				try
				{
				...
				//Pet Weight
				String petWeight = String.join(",", OKC_PropertyWare.petWeight);
				try
				{
				...
				try
				{
					if(OKC_PropertyWare.petRent.equalsIgnoreCase("Error"))
					{
					...
					RunnerClass.driver.findElement(Locators.petAmount).sendKeys(OKC_PropertyWare.petRent);
						}
						catch(Exception e)
						{
							...
							Thread.sleep(1000);
							//RunnerClass.actions.click(RunnerClass.driver.findElement(Locators.petAmount)).sendKeys(Keys.SHIFT).sendKeys(Keys.HOME).sendKeys(Keys.BACK_SPACE).build().perform();
							RunnerClass.driver.findElement(Locators.petAmount2).sendKeys(OKC_PropertyWare.petRent);
						}
					}
				}
				catch(Exception e)
				...
				try
				{
					if(OKC_PropertyWare.petOneTimeNonRefundableFee.equalsIgnoreCase("Error"))
					{
					...
					RunnerClass.driver.findElement(Locators.tenantOneTimePetFee).sendKeys(OKC_PropertyWare.petOneTimeNonRefundableFee);
						}
						catch(Exception e)
						{
							...
							//OKC_PropertyWare.clearTextField();
							//RunnerClass.actions.click(RunnerClass.driver.findElement(Locators.tenantOneTimePetFee)).sendKeys(Keys.SHIFT).sendKeys(Keys.HOME).sendKeys(Keys.BACK_SPACE).build().perform();
							RunnerClass.driver.findElement(Locators.petDepositAmount).sendKeys(OKC_PropertyWare.petOneTimeNonRefundableFee);
						}
					}
				}
				catch(Exception e)
				...
				try
				{
					...
					RunnerClass.driver.findElement(Locators.initialPetRentAmount).sendKeys(OKC_PropertyWare.petRent);
				...
				try
				{
					...
					RunnerClass.driver.findElement(Locators.petRentAmount).sendKeys(OKC_PropertyWare.petRent);
				...
				if(OKC_PropertyWare.serviceAnimalFlag==true)
				{
					Thread.sleep(2000);
					
					//Pet Type
					String ServiceAnimal_petType = String.join(",", OKC_PropertyWare.serviceAnimalPetType);
					try
					{
					...
					Thread.sleep(2000);
					//Pet Breed
					String serviceAnimal_petBreed = String.join(",", OKC_PropertyWare.serviceAnimalPetBreed);
					try
					{
					...
					Thread.sleep(2000);
					//Pet Weight
					String serviceAnimal_petWeight = String.join(",", OKC_PropertyWare.serviceAnimalPetWeight);
					try
					{
				...
				try
				{
					...
					if(RunnerClass.onlyDigits(OKC_PropertyWare.petSecurityDeposit.trim())==true)
					{
					RunnerClass.actions.moveToElement(RunnerClass.driver.findElement(Locators.petDepositAmount)).build().perform();
					//RunnerClass.driver.findElement(Locators.petAmount).clear();
					RunnerClass.driver.findElement(Locators.petDepositAmount).click();
					...
					Thread.sleep(1000);
					//RunnerClass.actions.click(RunnerClass.driver.findElement(Locators.petAmount)).sendKeys(Keys.SHIFT).sendKeys(Keys.HOME).sendKeys(Keys.BACK_SPACE).build().perform();
					RunnerClass.driver.findElement(Locators.petDepositAmount).sendKeys(OKC_PropertyWare.petSecurityDeposit);
					}
				}
				catch(Exception e)
				{
			...
			try
			{
				if(OKC_PropertyWare.monthlyRent.equalsIgnoreCase("Error"))
				{
				...
				RunnerClass.driver.findElement(Locators.initialMonthlyRent).sendKeys(OKC_PropertyWare.monthlyRent);
			...
			try
			{
				...
				//RunnerClass.driver.findElement(Locators.initialMonthlyRent).clear();
					...
					RunnerClass.driver.findElement(Locators.currentMonthlyRent).sendKeys(OKC_PropertyWare.monthlyRent);
	...
	public static void updateOtherFieldsInConfigurationTable() throws Exception
	{
		...
		OKC_GetDataFromDB.getChargesFromConfigurationTable();
		String DayInCommensementDate = RunnerClass.convertDate(OKC_PropertyWare.commensementDate).split("/")[1].trim();
		...
		{
			firstFullMonth = RunnerClass.convertDate(OKC_PropertyWare.commensementDate).trim();
			secondFullMonth = RunnerClass.firstDayOfFullMonth(RunnerClass.convertDate(OKC_PropertyWare.commensementDate));
			String updateStartDateAndEndDate = "Update "+OKC_RunnerClass.chargeCodesTable+" Set StartDate='"+RunnerClass.convertDate(OKC_PropertyWare.commensementDate)+"' where moveInCharge =1 \n"
					+ "Update "+OKC_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+secondFullMonth+"' where AutoCharge =1 \n"
							+ "Update "+OKC_RunnerClass.chargeCodesTable+" Set endDate='"+RunnerClass.DateModified(firstFullMonth)+"' where Charge ='Pro Rate Rent' ";
			InsertDataIntoDatabase.updateTable(updateStartDateAndEndDate);
		}
		else 
		{
		firstFullMonth = RunnerClass.firstDayOfFullMonth(RunnerClass.convertDate(OKC_PropertyWare.commensementDate));
		secondFullMonth = RunnerClass.NextMonthOffirstDayOfFullMonth(RunnerClass.convertDate(OKC_PropertyWare.commensementDate));
		String updateStartDateAndEndDate = "Update "+OKC_RunnerClass.chargeCodesTable+" Set StartDate='"+RunnerClass.convertDate(OKC_PropertyWare.commensementDate)+"' where moveInCharge =1 \n"
				+ "Update "+OKC_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+firstFullMonth+"' where AutoCharge =1 \n"
						+ "Update "+OKC_RunnerClass.chargeCodesTable+" Set endDate='"+RunnerClass.DateModified(firstFullMonth)+"' where Charge ='Pro Rate Rent' ";
		InsertDataIntoDatabase.updateTable(updateStartDateAndEndDate);
		}
		...
		if(RunnerClass.onlyDigits(OKC_PropertyWare.increasedRent_amount.trim().replace(",", "").replace(".", ""))==true)
		{
		String updateMonthlyRentStartDateToNextMonthOfFirstFullMonth = "Update "+OKC_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+RunnerClass.firstDayOfFullMonth(RunnerClass.convertDate(OKC_PropertyWare.commensementDate))+"',EndDate ='"+RunnerClass.convertDate(OKC_PropertyWare.increasedRent_previousRentEndDate.trim())+"'  where ID=2";
		...
		try
		{
		if(OKC_PropertyWare.portfolioType=="Others") //Double.parseDouble(OKC_PropertyWare.proratedRent.trim())<=200.00|| //||OKC_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true
		{
			String updateMonthlyRentStartDateWhenProrateRentIsUnder200Dollers = "Update "+OKC_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+secondFullMonth+"' where ID=2";
		...
		try
		{
		if(OKC_PropertyWare.proratedRentDateIsInMoveInMonthFlag==true&&(OKC_PropertyWare.proratedPetRent!=""||OKC_PropertyWare.proratedPetRent!=null||!OKC_PropertyWare.proratedPetRent.equalsIgnoreCase("na")||!OKC_PropertyWare.proratedPetRent.equalsIgnoreCase("n/a"))&&(DayInCommensementDate.equalsIgnoreCase("01")||DayInCommensementDate.equalsIgnoreCase("1"))) //Double.parseDouble(OKC_PropertyWare.proratedRent.trim())<=200.00||
		{
			String updateMonthlyRentStartDateWhenProrateRentIsUnder200Dollers = "Update "+OKC_RunnerClass.chargeCodesTable+" Set autoCharge_StartDate='"+secondFullMonth+"' where ID=8";
			InsertDataIntoDatabase.updateTable(updateMonthlyRentStartDateWhenProrateRentIsUnder200Dollers);
		}
		}
		catch(Exception e) {}
		...
		for(int i=0;i<charges.length;i++)
		{
			...
			{
			case "Pro Rate Rent":
				query = "Update "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.proratedRent+"' where charge ='Pro Rate Rent'";
				//InsertDataIntoDatabase.updateTable(query1);
				continue;
				
			case "Monthly Rent":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.monthlyRent+"' where charge ='Monthly Rent'";
				//InsertDataIntoDatabase.updateTable(query2);
				continue;
			case "Tenant Admin Revenue":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.adminFee+"' where charge ='Tenant Admin Revenue'";
				//InsertDataIntoDatabase.updateTable(query3);
				continue;
			case "Pro Rated Pet Rent":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.proratedPetRent+"' where charge ='Pro Rated Pet Rent'";
				//InsertDataIntoDatabase.updateTable(query4);
				continue;
			case "Pet Security Deposit":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.petSecurityDeposit+"' where charge ='Pet Security Deposit'";
				//InsertDataIntoDatabase.updateTable(query5);
				continue;
			case "Pet One Time Non Refundable":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.petOneTimeNonRefundableFee+"' where charge ='Pet One Time Non Refundable'";
				//InsertDataIntoDatabase.updateTable(query6);
				continue;
			case "HVAC Filter Fee":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.airFilterFee+"' where charge ='HVAC Filter Fee'";
				//InsertDataIntoDatabase.updateTable(query7);
				continue;
			case "Pet Rent":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.petRent+"' where charge ='Pet Rent'";
				//InsertDataIntoDatabase.updateTable(query8);
				continue;
			case "Pre Payment Charge":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.prepaymentCharge+"' where charge ='Pre Payment Charge'";
				//InsertDataIntoDatabase.updateTable(query9);
				continue;
			case "Increased Rent":
				try {
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.increasedRent_amount+"',autoCharge_StartDate ='"+RunnerClass.convertDate(OKC_PropertyWare.increasedRent_newStartDate)+"' where charge ='Increased Rent'";
			...
			case "Resident Benefits Package":
				if(OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("n/a")||OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("na")||OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("N/A")||OKC_PropertyWare.proratedRentDate.equalsIgnoreCase("NA"))
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.residentBenefitsPackage+"',startDate ='"+RunnerClass.convertDate(OKC_PropertyWare.commensementDate).trim()+"',autoCharge_startDate='"+secondFullMonth+"'  where charge ='Resident Benefits Package'";
				else
					query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.residentBenefitsPackage+"',startDate ='"+RunnerClass.convertDate(OKC_PropertyWare.commensementDate).trim()+"',autoCharge_startDate='"+firstFullMonth+"'  where charge ='Resident Benefits Package'";
				//InsertDataIntoDatabase.updateTable(query9);
				continue;
			case "Monthly Rent - New MCH":
				query = query+"\nUpdate "+OKC_RunnerClass.chargeCodesTable+" Set Amount ='"+OKC_PropertyWare.monthlyRent+"',startDate ='"+RunnerClass.convertDate(OKC_PropertyWare.commensementDate).trim()+"',autoCharge_startDate='"+firstFullMonth+"'  where ID = 12";
				//InsertDataIntoDatabase.updateTable(query9);
				continue;
			}
	...
	{
		if(OKC_PropertyWare.portfolioType=="Others"&&OKC_PropertyWare.petFlag==false)
		{
			if(OKC_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
			{
			...
			OKC_GetDataFromDB.assignChargeCodes(moveInCharges_1, autoCharges_1);
		}
		else
		{
			if(OKC_PropertyWare.portfolioType=="Others"&&OKC_PropertyWare.petFlag==true&&OKC_PropertyWare.petSecurityDepositFlag==false)
			{
				if(OKC_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
				{
			...
			else//(OKC_PropertyWare.portfolioType=="Others"&&OKC_PropertyWare.petFlag==true&&OKC_PropertyWare.petSecurityDepositFlag==true)
			{
				if(OKC_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
				{
	...
	{
		if(OKC_PropertyWare.portfolioType=="MCH"&&OKC_PropertyWare.petFlag==false)
		{
			if(OKC_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
			{
				moveInCharges_1 = "1,"+prepaymentChargeOrMonthlyRent+",3,11";
				if(OKC_PropertyWare.incrementRentFlag == true)
		...
		{
			if(OKC_PropertyWare.portfolioType=="MCH"&&OKC_PropertyWare.petFlag==true&&OKC_PropertyWare.petSecurityDepositFlag==false)
			{
				if(OKC_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
				{
		    ...
		    {
				if(OKC_PropertyWare.portfolioType=="MCH"&&OKC_PropertyWare.petFlag==true&&OKC_PropertyWare.petSecurityDepositFlag==true)
				{
					if(OKC_PropertyWare.residentBenefitsPackageAvailabilityCheck==true)
					{
	...
	public static void lateFeeRule() throws Exception
	{
		//Late Charges
		Thread.sleep(2000);
		if(OKC_PropertyWare.additionalLateChargesLimit.contains("375"))
		{
			OKC_PropertyWare.lateChargeDay = "2";
		}
		else OKC_PropertyWare.lateChargeDay = String.valueOf(OKC_PropertyWare.lateChargeDay.trim().charAt(0));

		try
		{
			if(OKC_PropertyWare.lateChargeDay.equalsIgnoreCase("Error"))
			{
			...
			dueDayList.selectByVisibleText(OKC_PropertyWare.lateChargeDay);
			}
		}
		catch(Exception e)
		{
		...
		try
		{
			if(OKC_PropertyWare.lateChargeFee.equalsIgnoreCase("Error"))
			{
			...
			RunnerClass.driver.findElement(Locators.initialFee).sendKeys(OKC_PropertyWare.lateChargeFee);
			}
		}
		catch(Exception e)
		{
		...
		try
		{
			if(OKC_PropertyWare.lateChargeFee.contains("%"))
			{
		...
		try
		{
			if(OKC_PropertyWare.lateFeeChargePerDay.equalsIgnoreCase("Error"))
			{
			...
			RunnerClass.driver.findElement(Locators.perDayFee).sendKeys(OKC_PropertyWare.lateFeeChargePerDay);
			}
		}
		catch(Exception e)
		{
		...
		if(OKC_RunnerClass.pdfFormatType.equalsIgnoreCase("Format1"))
	    {
			...
			if(OKC_PropertyWare.additionalLateChargesLimit.contains("30"))
			{
				OKC_PropertyWare.additionalLateChargesLimit = "12";
			...
			try
			{
				if(OKC_PropertyWare.additionalLateChargesLimit.equalsIgnoreCase("Error"))
				{
				...
				else
				{
					...
					RunnerClass.driver.findElement(Locators.maximumDatField).sendKeys(OKC_PropertyWare.additionalLateChargesLimit);
				}
			}
			catch(Exception e)
			{
		...
		public static boolean lateFeeRuleMethod(String type) throws Exception
		{
			...
			//if(OKC_PropertyWare.lateFeeType =="GreaterOfFlatFeeOrPercentage")
			//{
				try
				{
...
//				Thread.sleep(2000);
				...
				try
				{
					...
					RunnerClass.actions.moveToElement(RunnerClass.driver.findElement(Locators.lateFeeDueDay)).build().perform();
					Select dueDayList = new Select(RunnerClass.driver.findElement(Locators.lateFeeDueDay)) ;
					dueDayList.selectByVisibleText(OKC_PropertyWare.lateChargeDay.trim());
					}
				}
				catch(Exception e)
				{
