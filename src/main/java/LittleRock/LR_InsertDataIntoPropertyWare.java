	     ...
	     System.out.println("------Auto Charges-------");
			...
			//pet information
				...
				try
				{
					...
					{
					LR_RunnerClass.FL_actions.moveToElement(LR_RunnerClass.FL_driver.findElement(Locators.initialPetRentAmount)).build().perform();
					//LR_RunnerClass.FL_driver.findElement(Locators.initialMonthlyRent).clear();
					LR_RunnerClass.FL_driver.findElement(Locators.initialPetRentAmount).sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
					LR_RunnerClass.FL_driver.findElement(Locators.initialPetRentAmount).sendKeys(LR_PropertyWare.petRent);
				...
				try
				{
					...
					{
					LR_RunnerClass.FL_actions.moveToElement(LR_RunnerClass.FL_driver.findElement(Locators.petRentAmount)).build().perform();
					//LR_RunnerClass.FL_driver.findElement(Locators.initialMonthlyRent).clear();
					LR_RunnerClass.FL_driver.findElement(Locators.petRentAmount).sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
					LR_RunnerClass.FL_driver.findElement(Locators.petRentAmount).sendKeys(LR_PropertyWare.petRent);
			...
			try
			{
				...
				Thread.sleep(2000);
				if(LR_RunnerClass.FL_driver.findElement(Locators.saveLease).isDisplayed())
				{
					LR_RunnerClass.FL_actions.moveToElement(LR_RunnerClass.FL_driver.findElement(Locators.leaseOccupants)).build().perform();
					LR_RunnerClass.FL_driver.findElement(Locators.leaseOccupants).clear();
					LR_RunnerClass.FL_actions.moveToElement(LR_RunnerClass.FL_driver.findElement(Locators.saveLease)).click(LR_RunnerClass.FL_driver.findElement(Locators.saveLease)).build().perform();
